...
[cols=">,^,<",frame=none,grid=none,align=center]
|===
a|
[.right.text-right]
image::DocAssets/ByteStash.png[ByteStash Icon,30,30]
a|
[.center.text-center]
image::DocAssets/heart.png[Heart Icon,36,36]
a|
[.left.text-left]
image::DocAssets/FlowLauncher.png[FlowLauncher Icon,26,26]
|===
