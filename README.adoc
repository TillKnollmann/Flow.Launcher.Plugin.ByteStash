...
++++
<p align="center" style="margin-top:30px;margin-bottom:30px;"><a href="https://github.com/jordan-dalby/ByteStash"><img src= "DocAssets/ByteStash.png" width="10%"/></a><img src= "DocAssets/heart.png" width="15%"/><a href="https://www.flowlauncher.com"><img src= "DocAssets/FlowLauncher.png" width="10%"/></a></p>
++++
...
1. Select the snippet to update
    a. Type `stash q <search term>` to find the snippet, then _right-click_ or press _Shift+Enter_ on it and select "Edit snippet" from the context menu.
    b. Alternatively, go to the edit mode by typing `stash * <search term>`, then select the snippet from the results.
...
[.center.text-center]
image::DocAssets/UpdateAnimation.webp[Update animation]
